...
class PlatformsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create platform" do
    assert_difference('Platform.count') do
      post platforms_url, params: { platform: { api_url: @platform.api_url, name: @platform.name, url: @platform.url } }
    end
  ...
  test "should update platform" do
    patch platform_url(@platform), params: { platform: { api_url: @platform.api_url, name: @platform.name, url: @platform.url } }
